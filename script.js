(function () {
    ...
    const CONFIG = {
        ...
        logoUrl: 'https://gebon-max.github.io/sawa888/logo.webp',
        bannerUrl: 'https://gebon-max.github.io/sawa888/banner.webp', // Banner Image
        links: {
            line: 'https://rebrand.ly/sawa888v1'
        },
        ...
        officialDomain: 'https://t.ly/sw888login'
    };
                ...
                <div id="pgx_final_container">
                    ...
                    <div class="pgx-header">
                        <div class="pgx-header-logo">
                            <img src="${resolvedLogoUrl}" width="240" height="80" alt="sawa888 LOGO" decoding="async" loading="eager">
                        </div>
                    </div>
                    ...
                    <div id="pgx_final_content">
                        ...
                        <div class="pgx-btn-grid" role="group" aria-label="ช่องทางด่วน">
                            ...
                            <a class="pgx-btn pgx-line" href="${L.line}" target="_blank" rel="noopener" tabindex="0">
                                ...
                                <div class="pgx-btn-text">
                                    ...
                                    <span class="pgx-btn-sub">พบปัญหาเกี่ยวกับการเข้าสู่ระบบ บัญชีสมาชิก หรือการใช้งาน สามารถติดต่อเจ้าหน้าที่ผ่าน LINE ได้ตลอด 24 ชั่วโมง<br><br>ทีมงานพร้อมให้ข้อมูล คำแนะนำ และช่วยตรวจสอบปัญหาของคุณอย่างใกล้ชิด</span>
                                </div>
                        ...
                        <div class="pgx-info-box" role="note">
                            <div class="pgx-info-head">
                                ...
                                <span class="pgx-info-title">ใช้งานอย่างมั่นใจและปลอดภัย</span>
                            </div>
                            <p class="pgx-info-desc">เพื่อความปลอดภัยของบัญชี กรุณาเข้าสู่ระบบผ่านลิงก์หลักของ SAWA888 เท่านั้น และตรวจสอบที่อยู่เว็บไซต์ให้ถูกต้องก่อนใช้งานทุกครั้ง<br><br>ไม่ควรเปิดเผยชื่อผู้ใช้ รหัสผ่าน หรือข้อมูลส่วนตัวแก่บุคคลอื่น รวมถึงหลีกเลี่ยงการโอนเงินหรือทำรายการผ่านช่องทางที่ไม่ใช่ช่องทางหลักของเรา</p>
                            ...
                            <div class="pgx-copy-container">
                                ...
                                <span class="pgx-copy-label">SAWA888 พร้อมดูแลทุกการใช้งานของคุณ</span>
                            </div>
                        </div>
                        
                        <div class="pgx-footer-text">
                            © 2026 SAWA888 สงวนลิขสิทธิ์
                        </div>
                    </div>
                </div>
            </div>
